...
export default function QuestionCreationForm() {
  ...
  const createQuestion = async () => {
    ...
    if (correctIndex === -1) {
      handleWarningToast("Please select correct answer!");
      return;
    }
              ...
              <DialogContent className="sm:max-w-[700px] dark:bg-slate-800">
                ...
                <div className="grid gap-4 py-4">
                  <Textarea
                    ...
                    className="dark:text-white min-h-40 w-full bg-transparent border-none text-black text-lg resize-none focus:ring-0 placeholder:text-gray-400 placeholder:text-center"
                  />
                </div>
                <DialogFooter>
